    ...
    <div className="relative w-full h-80 md:h-[640px]">
      ...
      >
        <SwiperSlide className="relative">
          <Image src="/img/bg_slider01.jpg" alt="Slide 1" fill className="object-cover priority" />
        ...
        <SwiperSlide className="relative">
          <Image src="/img/bg_slider02.jpg" alt="Slide 3" fill className="object-cover priority" />
          <div className="bg-black/40 w-full h-full absolute"></div>
          <div className="relative px-4 break-keep">
        ...
        <SwiperSlide className="relative">
          <Image src="/img/bg_slider03.jpg" alt="Slide 3" fill className="object-cover priority" />
          <div className="bg-black/40 w-full h-full absolute"></div>
          <div className="relative px-4 break-keep">
